Rails.application.configure do
  ...
  config.force_ssl = false # FIXME: for now, for dokku testing
  ...
  # config.active_job.queue_name_prefix = "ghost_train_production"
  ...
  config.action_mailer.default_url_options = { host: Front.config[:domain] }
